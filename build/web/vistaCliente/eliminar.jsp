...
<section class="Delete">
    <div class="container">
        ...
        <form action="Cliente?accion=eliminarCliente" class="container__form" method="post">
            <input class="input" type="text" name="txtid" placeholder="Ingrese el IdCliente a eliminar">
