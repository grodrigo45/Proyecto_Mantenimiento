...
<section class="Delete">
    <div class="container">
        ...
        <form action="Principal?accion=eliminar" class="container__form" method="post">
            <input class="input" type="text" name="txtid" placeholder="Ingrese el idProducto de la fila a eliminar">
